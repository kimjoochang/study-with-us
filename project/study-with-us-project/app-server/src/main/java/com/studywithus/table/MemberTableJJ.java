...
// - 회원 데이터를 처리하는 일을 한다.
// 
public class MemberTableJJ extends JsonDataTable<Member> implements DataProcessor {

  public MemberTableJJ() {
  ...
  private void selectOneByNamePhoneNumber(Request request, Response response) throws Exception {
    String name = request.getParameter("name");
    String phoneNumber = request.getParameter("phoneNumber");
    Member member = null;
    // int type = 0;
