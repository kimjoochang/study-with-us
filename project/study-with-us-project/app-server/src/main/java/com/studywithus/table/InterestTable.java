...
//
public class InterestTable extends JsonDataTable<Study> implements DataProcessor {

  public InterestTable() {
    super("interest.json", Study.class);
  }

  @Override
  public void execute(Request request, Response response) throws Exception {
    switch (request.getCommand()) {
      case "interest.insert":
        insert(request, response);
        break;
      case "interest.selectList":
        selectList(request, response);
        break;
      case "interest.selectOne":
      ...
      case "interest.delete":
        ...
        break;
      case "interest.task.insert":
        insertTask(request, response);
        break;
      case "interest.task.update":
        updateTask(request, response);
        break;
      case "interest.task.delete":
