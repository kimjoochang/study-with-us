    ...
    <fieldset class="menu">
      ...
      <span class="study-top-status-2">
          <h1 class="study-content-category">
            스터디 상세보기 
            <input class="input5" id='f-status' type='text' name='status' value='${freeStudy.studyStatus}' readonly>
      ...
      <div class="form-group">
        ...
        <input id='f-name' type='text' name='name' value='${freeStudy.writer.name}' readonly>
      </div>
      
      <div class="form-group">
        <label class="study-content2" for='f-content'>내용</label>
        <input class="study-content-box" id='f-content' type='text' name='content' cols="69" rows="10" value='${freeStudy.content}' readonly>
      </div>
