...
public class FreeStudyHandler2 {
  ...
  public void add() {
    ...
    study.rule = Prompt.inputString("규칙? ");
  ...
  public void update() {
    ...
    String title = Prompt.inputString(String.format("[%s] 수정할 제목: ", study.title));
    String explanation = Prompt.inputString(String.format("[%s] 수정할 설명: ", study.explanation));
    String rule = Prompt.inputString(String.format("[%s] 수정할 규칙: ", study.rule));
