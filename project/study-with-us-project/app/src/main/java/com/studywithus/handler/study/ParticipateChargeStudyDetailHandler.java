...
public class ParticipateChargeStudyDetailHandler implements Command {
  ...
  List<Study> myParticipateChargeStudiesList;

  public ParticipateChargeStudyDetailHandler(HashMap<String, List<Study>> participateChargeStudyMap) {
  ...
  public void execute(CommandRequest request) throws Exception {
    ...
    myParticipateChargeStudiesList = participateChargeStudyMap.get(AuthLogInHandler.getLoginUser().getId());
  ...
  private Study findByNo(int no) {
    for (Study myParticipateChargeStudy : myParticipateChargeStudiesList) {
      if (myParticipateChargeStudy.getNo() == no) {
        return myParticipateChargeStudy;
      }
    }
    return null;
  }
