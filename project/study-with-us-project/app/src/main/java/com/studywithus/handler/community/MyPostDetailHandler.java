...
public class MyPostDetailHandler implements Command {
  ...
  public MyPostDetailHandler(List<Community> communityQaList, List<Community> communityInfoList, List<Community> communityTalkList) {
  ...
  /* 상세보기에서 수정/삭제로 이동
    ...
    if (loginUser == null || myPost.getWriter().getId() != loginUser.getId()) {
      return;
    }
