...
import com.studywithus.handler.study.MentorApplicationListHandler;
...
public class AppGR {
  ...
  public AppGR() {
    ...
    commandMap.put("/mentorApplicant/detail", new MentorApplicationDetailHandler(mentorApplicationFormList, mentorList));
