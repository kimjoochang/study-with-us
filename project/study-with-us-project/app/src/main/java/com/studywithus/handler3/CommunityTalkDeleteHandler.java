...
public class CommunityTalkDeleteHandler extends AbstractCommunityHandler{

  public CommunityTalkDeleteHandler(List<Community> communityList) {
    super(communityList);
  }
  ...
  @Override
  public void execute() {
    System.out.println("[커뮤니티 / 스몰톡 / 삭제] \n");
