...
public class ChargeStudyDetailHandlerSY extends AbstractStudyHandler {

	Study chargeStudy;
	List<Study> chargeInterestList; // 유료 스터디 관심목록 리스트 (회원 관점)

	public ChargeStudyDetailHandlerSY(List<Study> chargeStudyList, List<Study> chargeInterestList) {
	...
	public void execute(CommandRequest request) throws Exception {
		...
		while (true) {
			...
			if (chargeStudy.getWriter() == loginUser) {
				...
				int num = Prompt.inputInt("번호를 입력하세요. > ");
