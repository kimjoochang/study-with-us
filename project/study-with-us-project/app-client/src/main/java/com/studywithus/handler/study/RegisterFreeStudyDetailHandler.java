...
public class RegisterFreeStudyDetailHandler implements Command {
	...
	public void execute(CommandRequest request) {
		...
		List<Study> myRegisteredFreeStudy = registerFreeStudyMap.get(AuthLogInHandler.getLoginUser().getEmail());
	...
	private void studyMemberApproveHandler(Member freeApplicant, Study freeStudy) {
		...
		if (participateFreeStudyMap.containsKey(freeApplicant.getEmail())) {
			myParticipatedFreeStudy = participateFreeStudyMap.get(freeApplicant.getEmail());
			myParticipatedFreeStudy.add(freeStudy);
			participateFreeStudyMap.put(freeApplicant.getEmail(), myParticipatedFreeStudy);
