...
public class SnsLogInHandler implements Command {
  ...
  public void execute(CommandRequest request) throws Exception {
    ...
    String snsEmail = Prompt.inputString("이메일: ");
    ...
    if (member != null) {
      ...
      // 프로젝트에서 로그인한 회원의 정보는 모두 다 AuthLogInHandler.userAccessLevel를 확인하니까 snsLogin도 성공하면
      // AuthLoginHandler에 로그인한 회원 정보를 저장해야함 기존코드 (15 ~24번째 줄은 주석처리) member =
