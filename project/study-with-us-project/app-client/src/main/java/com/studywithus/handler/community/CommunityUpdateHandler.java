...
public class CommunityUpdateHandler implements Command {
  ...
  public CommunityUpdateHandler(RequestAgent requestAgent) {
  ...
  public void execute(CommandRequest request) throws Exception {
    ...
    String title =
        Prompt.inputString(String.format("[%s] 수정할 제목을 입력하세요. > ", community.getTitle()));
    String content =
        Prompt.inputString(String.format("[%s] 수정할 내용을 입력하세요. > ", community.getContent()));
    System.out.println();
