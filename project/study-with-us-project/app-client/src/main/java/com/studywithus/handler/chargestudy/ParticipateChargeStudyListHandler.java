...
public class ParticipateChargeStudyListHandler implements Command {
  ...
  public ParticipateChargeStudyListHandler(StudyMemberDao studyMemberDao) {
  ...
  public void execute(CommandRequest request) throws Exception {
    ...
    Collection<Study> chargeStudyList = 
        studyMemberDao.findAllStudy(AuthLogInHandler.getLoginUser().getNo(), Study.PARTICIPANT_STATUS);
