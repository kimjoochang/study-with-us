...
public class FreeStudyApplyListHandler implements Command {
  ...
  public FreeStudyApplyListHandler(StudyDao freeStudyDao) {
  ...
  public void execute(CommandRequest request) throws Exception {
    ...
    Collection<Study> freeStudyList = freeStudyDao.findAllApplyStudy(AuthLogInHandler.getLoginUser().getNo());
