...
public class FreeStudyApplyListHandler implements Command {
  ...
  public FreeStudyApplyListHandler( StudyMemberDao studyMemberDao) {
  ...
  public void execute(CommandRequest request) throws Exception {
    ...
    Collection<Study> freeStudyList = studyMemberDao.findAllStudy(AuthLogInHandler.getLoginUser().getNo(), Study.APPLICANT_STATUS);
